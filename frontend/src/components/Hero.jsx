...
const Hero = () => {
  return (
    <div name='home' className='w-full max-h-[1024px] bg-zinc-200 flex flex-col justify-between'>
        <div className='bg-gray-100 grid md:grid-cols-2 max-w-[1024px] mx-8'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 '>
                <h1 className='py-3 text-4xl md:text-5xl lg:text-7xl font-bold'>Let's find <span className="text-yellow-400">your Mentor</span></h1>
                <h1 className='py-3 text-3xl md:text-5xl lg:text-7xl font-bold'>Build <span className="text-yellow-400">your code</span></h1>
