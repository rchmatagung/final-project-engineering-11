                        ...
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md hover:scale-100 hover:bg-yellow-400 bg-white">
                                ...
                                <div className="px-6 my-16">
                                    ...
                                    <p className="text-gray-600 text-sm text-center">(Universitas Methodist Indonesia)</p>
                                </div>
                            </div>
                        </div>
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white hover:scale-100 hover:bg-yellow-400">
                                ...
                                <div className="px-6 my-16">
                                    ...
                                    <p className="text-gray-600 text-sm text-center">Frontend</p>
                                    <p className="text-gray-600 text-sm text-center">(Universitas Lampung)</p>
                                </div>
                            </div>
                        </div>
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white hover:scale-100 hover:bg-yellow-400">
                                ...
                                <div className="px-6 my-16">
                                    ...
                                    <p className="text-gray-600 text-sm text-center">(Universitas Gadjah Mada)</p>
                                </div>
                            </div>
                        </div>
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white hover:scale-100 hover:bg-yellow-400">
                                ...
                                <div className="px-6 my-16">
                                    ...
                                    <p className="text-gray-600 text-sm text-center">Backend</p>
                                    <p className="text-gray-600 text-sm text-center">(Universitas Gunadarma)</p>
                                </div>
                            </div>
                        </div>
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white hover:scale-100 hover:bg-yellow-400">
                                ...
                                <div className="px-6 my-16">
                                    ...
                                    <p className="text-gray-600 text-sm text-center">Backend</p>
                                    <p className="text-gray-600 text-sm text-center">(STT Terpadu Nurul Fikri)</p>
                                </div>
                            </div>
                        </div>
                    </div>
