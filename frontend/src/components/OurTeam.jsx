                    ...
                    <div className="lg:flex md:flex sm:flex items-center flex-wrap md:justify-around sm:justify-around lg:justify-around">
                            ...
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src={logoImg} alt="OurTeam-Halomoan Nababan" className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                        ...
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src={logoImg} alt="OurTeam-Meilika Dwi Putri" className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 my-16">
                        ...
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src={logoImg} alt="OurTeam-Muhammad Kevin Rozal" className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 my-16">
                        ...
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src={logoImg} alt="OurTeam-Satrio Wibowo" className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 my-16">
                        ...
                        <div className="sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 lg:w-2/5">
                            <div className="rounded overflow-hidden shadow-md bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src={logoImg} alt="OurTeam-Arisandi" className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 my-16">
